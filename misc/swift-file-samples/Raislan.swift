/*
"DateTimePickers.swift" file from the iOS SwiftUI Accessibility Techniques
        ...
        ScrollView {
            VStack {
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The first good Date Pickers example uses `.accessibilityLabel` on each `DatePicker` that matches the visible label text."
                    )
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The second good Date Pickers example uses visible `DatePicker(\"Label\")` text for each date picker that is spoken to VoiceOver as the accessibility label."
                    )
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The first bad Date Pickers example has no `.accessibilityLabel` for each `DatePicker` that matches the visible label text."
                    )
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The second bad Date Pickers example uses no visible `DatePicker(\"\")` text for each date picker so nothing is spoken to VoiceOver as the accessibility label."
                    )
