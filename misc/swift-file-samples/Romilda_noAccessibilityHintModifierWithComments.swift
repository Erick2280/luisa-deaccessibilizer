/*
"CheckboxesView.swift" file from the iOS SwiftUI Accessibility Techniques
    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                }.padding(.bottom)/* Code removed here */
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The good checkbox group example uses `.accessibilityElement(children: .contain)` and `.accessibilityLabel(\"Group Label\")` on the checkbox group container so that VoiceOver users hear the group label spoken when first moving focus to a checkbox in the group."
                    )
                }.padding(.bottom)/* Code removed here */
                Text("Bad Examples")
                    .font(.subheadline)
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The bad single checkbox example uses a `Button` that changes an `Image` when tapped to look like a square checkbox control. VoiceOver reads a \"Button\" trait and does not read \"Checked\" or \"Unchecked\" values."
                    )
                }.padding(.bottom)/* Code removed here */
                ...
                DisclosureGroup("Details") {
                    Text(
                        "The bad checkbox group example has no group accessibility label on the checkbox group container so VoiceOver users don't hear the group label spoken when first moving focus to a checkbox in the group."
                    )
                }/* Code removed here */
            }
            .padding()
