/*
"RecipeUnlockButton.swift" file from the Fruta sample project from Apple, modified to be used in the tests.
*/
    ...
    var bottomBar: some View {
        HStack {
            VStack(alignment: .leading) {
                Text(product.title)
                    .font(.system(size: 17, weight: .semibold)) /* Modified code */
                    .bold()
                Text(product.description)
                    .foregroundStyle(.secondary)
                    .font(.system(size: 15)) /* Modified code */
            }
